...
class ApollonModel {
    constructor(config) {
        ...
        this.RESERVE_SEAT = config.reserveSeat || 1;
    ...
    getGames() {
        return {
            'Adrian-EveryoneIsJohn': {
                ...
                lang: 'DE',
                playersMax: 5 - this.RESERVE_SEAT,
            },
            'Adrian-Shadowrun': {
                ...
                lang: 'DE',
                playersMax: 4 - this.RESERVE_SEAT,
            },
            ...
            'Oliver-Workshop': {
                ...
                lang: 'DE',
                playersMax: 6 - this.RESERVE_SEAT,
            },
            'Oliver-SdDf': {
            ...
            'Victor-DnD': {
                ...
                lang: 'EN',
                playersMax: 8 - this.RESERVE_SEAT,
            },
            ...
            'Flutschi-Character': {
                ...
                campaignDescription: '',
                lang: 'DE',
                playersMax: 11 - this.RESERVE_SEAT,
            },
            ...
            'Martin-DSA': {
                ...
                lang: 'DE',
                playersMax: 3 - this.RESERVE_SEAT,
            },
    ...
    getRounds() {
        return {
            'Adrian-0': {
                gameId: 'Adrian-EveryoneIsJohn',
                day: 'friday',
                from: 19,
                to: 21.5
            },
            'Adrian-1': {
                gameId: 'Adrian-Shadowrun',
                day: 'friday',
                from: 22,
                to: 25
            },
            ...
            'Kevin-0': {
                gameId: 'Kevin-Cthulhu-Zahltag',
                day: 'friday',
                from: 19,
                to: 25
            },
            'Kevin-1': {
                gameId: 'Kevin-Paranoia',
                day: 'saturday',
                from: 13,
                to: 15.5
            },
            'Kevin-2': {
                gameId: 'Kevin-Cthulhu-Filmriss',
                day: 'saturday',
                from: 16,
                to: 18.5
            },
            'Kevin-3': {
                gameId: 'Kevin-Pathfinder',
                day: 'saturday',
                from: 19.5,
                to: 25
            },
            ...
            'Manuela-0': {
                gameId: 'Manuela-Finsterland-Stadt',
                day: 'friday',
                from: 19.5,
                to: 22
            },
            'Manuela-1': {
                gameId: 'Manuela-Finsterland-Piraten',
                day: 'saturday',
                from: 16,
                to: 18.5
            },
            ...
            'Stefan-0': {
                gameId: 'Stefan-DnD-Aufklaerung',
                day: 'friday',
                from: 19.5,
                to: 25
            },
            'Stefan-1': {
                gameId: 'Stefan-DnD-Befreiung',
                day: 'saturday',
                from: 13,
                to: 18.5
            },
            ...
            'GianMarco-0': {
                gameId: 'GianMarco-Dungeonslayer',
                day: 'friday',
                from: 19,
                to: 21.5
            },
    ...
    async getRegistrations() {
        ...
        if (this.olymp.constructor == OlympMock) {
            this.olymp.resourceAdd(APOLLON_UID);
            await this.olymp.entriesAdd(APOLLON_UID, 'a@unknown.tld', {
                rounds: ['Adrian-0', 'Adrian-1']
            }, {
                name: 'a',
                email: 'a@unknown.tld'
            });
            await this.olymp.entriesAdd(APOLLON_UID, 'b@unknown.tld', {
                rounds: ['Adrian-0']
            }, {
                name: 'b',
                email: 'b@unknown.tld'
            });
            await this.olymp.entriesAdd(APOLLON_UID, 'c@unknown.tld', {
                rounds: ['Adrian-0']
            }, {
                name: 'c',
                email: 'c@unknown.tld'
            });
            await this.olymp.entriesAdd(APOLLON_UID, 'd@unknown.tld', {
                rounds: ['Adrian-0']
            }, {
                name: 'd',
                email: 'd@unknown.tld'
            });
            await this.olymp.entriesAdd(APOLLON_UID, 'e@unknown.tld', {
                rounds: ['Adrian-0']
            }, {
                name: 'e',
                email: 'e@unknown.tld'
            });
            await this.olymp.entriesAdd(APOLLON_UID, 'f@unknown.tld', {
                rounds: ['Adrian-1']
            }, {
                name: 'f',
                email: 'f@unknown.tld'
        ...
        const registrations = await this.olymp.entriesList(this.APOLLON_UID);
        return registrations;
    }

    async registrationAdd(name, email, comment, rounds) {
        ...
        await this.olymp.entriesAdd(this.APOLLON_UID, identification, publicBody, privateBody);
    }

    roundsDetailed(registrations) {
    ...
    roundsDayTimeOverlapping(roundIdOthers) {
